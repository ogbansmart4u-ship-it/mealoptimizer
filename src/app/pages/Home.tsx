      ...
      <div className="px-6">
        ...
        <div className="mb-5">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-[#1f7a8c] to-[#4ecdc4] text-white rounded-2xl py-3.5 flex items-center justify-center gap-2 hover:shadow-md transition-all font-semibold"
          >
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button
              ...
              className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center border-2 border-teal-400 hover:scale-105 hover:-translate-y-1 group cursor-pointer">
            ...
            <button
              ...
              className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center border-2 border-[#1f7a8c] hover:scale-105 hover:-translate-y-1 group cursor-pointer">
            ...
            <button
              ...
              className="col-span-2 bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center gap-0 border-2 border-[#1f7a8c] hover:scale-[1.02] group cursor-pointer"
            >
