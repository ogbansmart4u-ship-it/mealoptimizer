    ...
    <div className="min-h-screen bg-[#F7F9F8] flex flex-col">
      ...
      <div className="flex-1 px-6 pb-10">
        ...
        >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 h-12 bg-[#ffffff] rounded-xl focus-visible:ring-[#1f7a8c] focus-visible:border-[#1f7a8c] ${fieldErrors.email ? 'border-red-400' : 'border-[#CBD5E1]'}`}
                  required
                />
              </div>
              {fieldErrors.email && (
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 pr-10 h-12 bg-[#ffffff] rounded-xl focus-visible:ring-[#1f7a8c] focus-visible:border-[#1f7a8c] ${fieldErrors.password ? 'border-red-400' : 'border-[#CBD5E1]'}`}
                  required
                />
                <button
                  type="button"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 pr-10 h-12 bg-[#ffffff] rounded-xl focus-visible:ring-[#1f7a8c] focus-visible:border-[#1f7a8c] ${fieldErrors.confirmPassword ? 'border-red-400' : 'border-[#CBD5E1]'}`}
                  required
                />
                <button
                  type="button"
          ...
          {/* Social Sign Up (Android Store Ready - Apple Sign Up can be re-enabled when listing on iOS App Store) */}
          <div className="space-y-3">
            <button
              className="w-full flex items-center justify-center gap-3 bg-[#ffffff] border border-[#E2E8F0] rounded-xl py-3 hover:bg-[#F8FAFC] hover:scale-[1.01] transition-all duration-200 ease-out text-sm font-medium text-[#1E293B] disabled:opacity-50 cursor-pointer shadow-2xs"
