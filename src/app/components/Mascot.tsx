...
const GESTURE_ASSETS: Record<string, { webm: string; webp: string }> = {
  ...
  thumbsup: { webm: "/assets/mascot/avo-thumbsup.webm", webp: "/assets/mascot/avo-thumbsup.webm" },
  "thumbs-up": { webm: "/assets/mascot/avo-thumbsup.webm", webp: "/assets/mascot/avo-thumbsup.webm" },
  pointing: { webm: "/assets/mascot/avo-thumbsup.webm", webp: "/assets/mascot/avo-thumbsup.webm" },
  double_thumbsup: { webm: "/assets/mascot/avo-thumbsup.webm", webp: "/assets/mascot/avo-thumbsup.webm" },
