...
export const SUBSCRIPTION_PLANS: PlanPricing[] = [
  {
    ...
    features: [
      "3 meal logs per day",
      "Standard African food & soup database",
      "Daily hydration & water tracker",
      "Basic weight & blood pressure logs",
    ],
    cta: "Continue Free",
  },
  {
    ...
    badge: "Personal Health Shield",
    popular: true,
    description: "Eat your favorite cultural foods while keeping blood sugar, BP, and weight under complete control.",
    prices: {
    ...
    features: [
      "Unlimited AI Camera Food Scans (Instant carbs, calories & glycemic impact)",
      "WhatsApp Food Logger (Snap photos or voice in English & Pidgin)",
      "'Fix My Plate' Cultural Swaps (Keep swallows & stews without spikes)",
      "1-Tap Doctor Visit PDF Dossiers (14-day A1c & glucose trends)",
      "Smartwatch & Sensor Live Sync (Dexcom, Libre & Apple Health)",
      "Diaspora vs. Local Ingredient Swaps (UK/US vs. West Africa markets)",
    ],
    cta: "Start My Metabolic Care",
  },
  {
    id: "family",
    name: "Diaspora Parent Care",
    badge: "Peace of Mind for Parents",
    description: "Look after your parents back home. They log meals on WhatsApp; you receive instant spike alerts abroad.",
    prices: {
    ...
    features: [
      "Full PRO access for up to 3 family members",
      "Elderly parents log meals via WhatsApp (Zero tech learning required)",
      "Instant alerts sent to children abroad when blood sugar spikes",
      "Weekly Clinical Doctor PDF summaries emailed directly to you",
      "Priority Clinical Dietitian consultation for your parents",
    ],
